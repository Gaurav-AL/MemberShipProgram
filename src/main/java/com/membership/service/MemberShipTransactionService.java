...
public class MemberShipTransactionService {
    ...
    public void saveUpgradedTransaction(Long UserId, PlanTier from_tier , PlanTier to_tier, PlanType planType){
    ...
    public void saveDowngradedTransaction(Long UserId, PlanTier from_tier , PlanTier to_tier,PlanType planType){
    ...
    public void saveCancelledTransaction(Long UserId, PlanTier from_tier , PlanTier to_tier, PlanType planType){
